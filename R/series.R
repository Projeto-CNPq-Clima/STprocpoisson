...
#' \describe{
#'   \item{m}{The number of days in the observation period (3652 for a 10-year period including leap years).}
#'   \item{columns}{Each column represents daily precipitation (in mm) recorded at one of the 20 rain gauges.}
#' }
#'
#' @details
...
#'
#' The dataset is available from the Meteorological Database for Teaching and Research (\url{https://bdmep.inmet.gov.br}) and the ANA Open Data Portal (\url{https://dadosabertos.ana.gov.br}).
#'
