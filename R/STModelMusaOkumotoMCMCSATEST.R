...
STModelMusaOkumotoMCMCSATEST <- function(data, sites,X=cbind(as.matrix(rep(1,ncol(data))),(1/100)*sites),
 ...
 # delta=0.001
  ...
  for(i in 1:ncol(data)){
    mmmtemp=optim(c(1, 1), logverouniMUSA, c(1, 1),data[, i],sum(!is.na(data[, i])), nnjj[i])
